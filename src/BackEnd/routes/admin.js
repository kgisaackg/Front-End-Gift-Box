...
router.get("/payments", (req, res) => {
  ...
  payments =
    "SELECT a.firstname,a.lastname, b.* FROM order_tbl b,customer a WHERE a.cust_id = b.cust_id ORDER BY b.order_date DESC; ";
  //+ Options
...
router.get("/payment:id", (req, res) => {
  ...
  payments =
    "SELECT * FROM order_tbl WHERE cust_id = ? ORDER BY order_date DESC; ";
  //+ Options
  mysqlConn.conn.query(payments, [id], (rows, results, error) => {
    try {
      console.log(results)
      res.json(results);
    } catch (error) {
